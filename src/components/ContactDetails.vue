<template>
    <v-container fluid ma-0 pa-0 id="contact">
            <v-card flat tile class="white--text text-center ma-0 pa-0" style="height: 100%; background-image: url('./mosaicGreen.jpg'); background-size: contain; background-repeat:repeat">
