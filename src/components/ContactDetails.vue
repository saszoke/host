<template>
    <v-container fluid ma-0 pa-0 id="contact">
        <v-card flat tile class="white--text text-center ma-0 pa-0" style="background-image: url('./mosaicmod6KevesbeVilagos.png'); background-size: contain; background-repeat:repeat-x">
